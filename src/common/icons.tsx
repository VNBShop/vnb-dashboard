    ...
    case 'Report': {
      return (
        ...
        >
          <path
            fill={color}
            d="M12 16.423q.262 0 .438-.177q.177-.177.177-.438q0-.262-.177-.439q-.176-.177-.438-.177t-.438.177q-.177.177-.177.439q0 .261.177.438q.176.177.438.177Zm-.5-2.961h1V7.385h-1v6.077ZM8.673 20L4 15.336V8.673L8.664 4h6.663L20 8.664v6.663L15.336 20H8.673Z"
          />
        </svg>
      )
    }
    ...
    case 'WarehouseHistory': {
      return (
        ...
        >
          <path
            fill={color}
            d="M11.192 3.313q.38-.217.808-.217t.808.217l6.384 3.68q.38.217.594.59q.214.373.214.807v2.802q-.677-.35-1.44-.54q-.762-.19-1.58-.19q-.443 0-.87.047q-.425.047-.845.166L19 8.523v-.242q0-.096-.048-.193q-.048-.096-.144-.153l-.383-.222L12 11.427L5.575 7.713l-.383.222q-.096.057-.144.153Q5 8.185 5 8.281v.242l6.5 3.764v.998q-.61.838-.94 1.825q-.33.986-.33 2.102q0 .953.25 1.826q.249.874.697 1.64q-.006-.005-.012-.005q-.005 0-.011-.006l-6.346-3.66q-.38-.217-.594-.59Q4 16.044 4 15.61V8.39q0-.434.214-.807q.215-.373.594-.59l6.384-3.68ZM17 21.231q-1.671 0-2.836-1.165T13 17.231q0-1.671 1.164-2.836T17 13.231q1.671 0 2.836 1.164T21 17.231q0 1.67-1.164 2.835T17 21.231Zm.385-4.162v-2.723h-.77v3.046l2.035 2.035l.546-.546l-1.811-1.812Z"
          />
        </svg>
      )
    }
    ...
    case 'Reload': {
      return (
        ...
        >
          <path
            fill={color}
            d="M2 12a9 9 0 0 0 9 9c2.39 0 4.68-.94 6.4-2.6l-1.5-1.5A6.706 6.706 0 0 1 11 19c-6.24 0-9.36-7.54-4.95-11.95C10.46 2.64 18 5.77 18 12h-3l4 4h.1l3.9-4h-3a9 9 0 0 0-18 0"
          />
        </svg>
      )
    }
    ...
    case 'Lock': {
      return (
        ...
        >
          <path
            fill={color}
            d="M12 8V4.9C12 2.7 10.4 1 8.2 1h-.3C5.8 1 4 2.7 4 4.9V8H3l.1 5S3 16 8 16s5-3 5-3V8zm-3 6H8v-2c-.6 0-1-.4-1-1s.4-1 1-1s1 .4 1 1zm1-6H6V4.9C6 3.8 6.9 3 7.9 3h.3c1 0 1.8.8 1.8 1.9z"
          />
        </svg>
      )
    }
